...
--  Tests for Alog protected logger component.
package Protected_Logger_Tests is
   ...
   --  Test protected logger instance initialization behavior.

   procedure Default_Facility_Handling;
   --  Test attaching/detaching of default facility.

   procedure Tasked_One_FD_Facility;
   --  Test tasked logging to protected logger with one fd based facility.

   procedure Verify_Iterate_Facilities;
   --  Test iterate for facilities of protected logger.

   procedure Verify_Iterate_Transforms;
   --  Test iterate for transforms of protected logger.
